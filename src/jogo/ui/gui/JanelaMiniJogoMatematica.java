...
public class JanelaMiniJogoMatematica extends BorderPane
{
    ...
    public JanelaMiniJogoMatematica(JogoCareTakerObservable jogo, int width, int height)
    {
        this.jogo = jogo;
        setWidth(width);
        setHeight(height);
    ...
    private void dispoeVista()
    {
        ...
        Label lblTitulo = new Label("MINI JOGO MATEMÁTICA");
    ...
    private void update()
    {
        ...
        lblDescricao.setText("Tem " + (jogo.getMiniJogoAtual().getTempo() - jogo.getMiniJogoAtual().getTempoPassado()) + " segundos para acertar 5 resultados!");
